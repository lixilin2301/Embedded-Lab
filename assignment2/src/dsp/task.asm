...
;* Date/Time created: Thu May 21 12:39:23 2015                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/home/ubuntu/Desktop/pool_notify/dsp")
;*****************************************************************************
;* CINIT RECORDS                                                             *
;*****************************************************************************
	.sect	".cinit"
...
;	/data/usr/local/share/c6000/bin/opt6x /tmp/09523wvdY6R /tmp/095232l68Zh 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$45	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$45, DW_AT_name("/home/ubuntu/Desktop/pool_notify/dsp/task.asm:$C$L3:1:1432204763")
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("/home/ubuntu/Desktop/pool_notify/dsp/task.asm:$C$L1:1:1432204763")
...
$C$DW$61	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$61, DW_AT_name("/home/ubuntu/Desktop/pool_notify/dsp/task.asm:$C$L9:1:1432204763")
...
$C$DW$63	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$63, DW_AT_name("/home/ubuntu/Desktop/pool_notify/dsp/task.asm:$C$L7:1:1432204763")
