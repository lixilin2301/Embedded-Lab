...
;* Date/Time created: Mon Apr 20 18:45:05 2015                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/data/imran/delft/phd/taShip/ESLab2015/helperExamples/pool_notify/dsp")
;*****************************************************************************
;* CINIT RECORDS                                                             *
;*****************************************************************************
	.sect	".cinit"
...
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/18590DZiPOA /tmp/185903Rb57r 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$45	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$45, DW_AT_name("/data/imran/delft/phd/taShip/ESLab2015/helperExamples/pool_notify/dsp/task.asm:$C$L3:1:1429548305")
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("/data/imran/delft/phd/taShip/ESLab2015/helperExamples/pool_notify/dsp/task.asm:$C$L1:1:1429548305")
...
$C$DW$61	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$61, DW_AT_name("/data/imran/delft/phd/taShip/ESLab2015/helperExamples/pool_notify/dsp/task.asm:$C$L9:1:1429548305")
...
$C$DW$63	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$63, DW_AT_name("/data/imran/delft/phd/taShip/ESLab2015/helperExamples/pool_notify/dsp/task.asm:$C$L7:1:1429548305")
